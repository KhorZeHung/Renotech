...
type OrderItem struct {
	...
	// Project Mapping (for reference)
	ProjectArea     string              `bson:"projectArea" json:"projectArea"`       // Which project area this relates to
	OriginalMaterial *primitive.ObjectID `bson:"originalMaterial" json:"originalMaterial"` // Original project material reference
}